...
export const de = {
  ...
  previousPage: 'Zurück',
  nextPage: 'Weiter',
  pageOf: (current: string, total: string) => `Seite ${current} von ${total}`,
  subscribePrompt: 'Abonnieren Sie, um detaillierte Nährwerte für dieses Produkt zu sehen.',
  subscribeGlobalTitle: 'Nährwerte freischalten',
  subscribeGlobalPrompt: 'Abonnieren Sie für Energie, Fett, Zucker und mehr zu jedem Produkt.',
