...
export const nl = {
  ...
  paginationLabel: "Pagina's met zoekresultaten",
  previousPage: 'Vorige',
  nextPage: 'Volgende',
  pageOf: (current: string, total: string) => `Pagina ${current} van ${total}`,
  subscribePrompt: 'Abonneer om gedetailleerde voedingswaarden voor dit product te zien.',
  subscribeGlobalTitle: 'Ontgrendel voedingswaarden',
  subscribeGlobalPrompt: 'Neem een abonnement voor energie, vet, suikers en meer bij elk product.',
